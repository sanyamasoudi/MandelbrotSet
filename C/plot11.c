...
int main()
{
    ...
    myImage.bmHeader.colorIdx[8].r= 238;myImage.bmHeader.colorIdx[8].g= 224;myImage.bmHeader.colorIdx[8].b= 229;
    myImage.bmHeader.colorIdx[9].r = 205;myImage.bmHeader.colorIdx[9].g= 193;myImage.bmHeader.colorIdx[9].b= 197;
    myImage.bmHeader.colorIdx[10].r = 139;myImage.bmHeader.colorIdx[10].g= 131;myImage.bmHeader.colorIdx[10].b= 134;
    myImage.bmHeader.colorIdx[11].r= 186;myImage.bmHeader.colorIdx[11].g= 85;myImage.bmHeader.colorIdx[11].b= 211;
    ...
    for(int x=0; x<1920; x++)
    {
        ...
        {
            float real=-2.5+(float)x/1920*4;
            float image=-1.5+(float)y/1080*3;
            float complex C=real+image*I;
            m = mandelbrot(C);
            if(7.5<m && m<8)
            {
               myImage.bmData[y*1920 + x] =7; 
            }
            else if(8<m && m<9.5)
            {
               myImage.bmData[y*1920 + x] =6; 
            }
            else if(9.5<m && m<12)
            {
               myImage.bmData[y*1920 + x] =5; 
            }
            else if(12<m && m<16.5)
            {
               myImage.bmData[y*1920 + x] =4; 
            }
            else if(16.5<m && m<17)
            {
               myImage.bmData[y*1920 + x] =3; 
            }
            else if(17<m && m<23)
            {
               myImage.bmData[y*1920 + x] =7; 
            ...
            {
               myImage.bmData[y*1920 + x] =1; 
            }
            else if(30<m && m<37)
            {
               myImage.bmData[y*1920 + x] =2; 
            }
            else if(m>37)
            {
                myImage.bmData[y*1920+ x] = 0;
            }
            
        }
    }
    
    WriteBitmapFile("simple_test12.bmp", &myImage);
}
